...
const outerColorWhenCommandedAndChangedDest = "#700";                   // marron
const outerColorWhenCommandedAndEmergencyExit = "#f1a";                 // violet
const outerColorWhenCommandedAndChangedDestAndEmergencyExit = "#e1f";   // pink
