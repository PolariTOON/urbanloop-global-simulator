...
def serialize_config():
    return {
        'travelers_per_day': int(config.traveler['travelers_per_day']),
        'trip_limit': int(config.traveler['trip_limit']),
        'traveler_limit': int(config.traveler['traveler_limit']),
        'ascent_descent_duration': int(config.traveler['ascent_descent_duration']),
        'morning_peak_hour': int(config.traveler['morning_peak_hour']),
        'evening_peak_hour': int(config.traveler['evening_peak_hour']),
        'network_file': config.topology['network_file'],
        'activity_and_residential_percent': int(config.prob['activity_and_residential_percent']),
        'city_percent': int(config.prob['city_percent']),
